...
#--------------------------------------------
FSUB_LINK_EXPIRY = int(os.getenv("FSUB_LINK_EXPIRY", "180"))  # 0 means no expiry
...
TUT_VID = os.environ.get("TUT_VID","https://t.me/howtoopenlink5/15")
