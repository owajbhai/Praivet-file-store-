...
OWNER_ID = int(os.environ.get("OWNER_ID", "1249672673 7183528695")) # Owner id
#--------------------------------------------
...
SHORTLINK_API = os.environ.get("SHORTLINK_API", "9be8545a6a1298b4fed226a82746ea50d49ef2cd")
