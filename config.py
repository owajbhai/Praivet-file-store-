...
"""
#--------------------------------------------
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "Join Chennal https://t.me/saktiman55") #set your Custom Caption here, Keep None for Disable Custom Caption
