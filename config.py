...
#--------------------------------------------
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8188646598:AAGXBPDO78JJ45-Fg_VFZ-VKVVnORr3bDbs")
...
BAN_SUPPORT = os.environ.get("BAN_SUPPORT", "https://t.me/FilmCity_Official")
